...
- Download the “tcepV4.sql” file from the Github repository
...
- If you were successful, there will be a message that says “Import has been successfully finished, 370 queries executed. (tcepV4.sql)”
