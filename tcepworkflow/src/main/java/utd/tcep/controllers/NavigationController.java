...
public class NavigationController {
    ...
    // Ryan Pham
    public void swapView(String fxml) throws IOException {
        if (currentView != null) {
        ...
        if (controller instanceof FormDetailedController) {
            ((FormDetailedController) controller).setNavigationController(this);
        }
