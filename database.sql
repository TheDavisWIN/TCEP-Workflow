-- Writen by Ayden Benel (acb210001)
-- Completely reset the database
-- This was used because when getting the database added I made mistakes and dropped the whole database to fix it
...
-- Each status Awaiting Review, Sent Back for Info belongs to a Category
